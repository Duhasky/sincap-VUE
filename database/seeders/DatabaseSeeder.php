...
class DatabaseSeeder extends Seeder
{
	...
	public function run(): void
	{
		...
		$role->abilities()->create(['name' => 'person_create']);
		$role->abilities()->create(['name' => 'person_read']);
		$role->abilities()->create(['name' => 'person_update']);
		$role->abilities()->create(['name' => 'person_delete']);

		$role->abilities()->create(['name' => 'city_create']);
		$role->abilities()->create(['name' => 'city_read']);
		$role->abilities()->create(['name' => 'city_update']);

		$role->abilities()->create(['name' => 'group_create']);
		$role->abilities()->create(['name' => 'group_read']);
		$role->abilities()->create(['name' => 'group_update']);
